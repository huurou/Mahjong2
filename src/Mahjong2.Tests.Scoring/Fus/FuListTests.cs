...
public class FuListTests
{
    ...
    public void Total_符の合計値が10の単位に切り上げられること()
    {
        ...
        var testCases = new[]
       {
            (Fus: new FuList([Fu.FuteiFu, Fu.TsumoFu]), Expected: 30),                    // 20 + 2 = 22 → 30
            (Fus: new FuList([Fu.FuteiFu, Fu.MinkoYaochuFu, Fu.TsumoFu]), Expected: 30),    // 20 + 4 + 2 = 26 → 30
            (Fus: new FuList([Fu.FuteiFu, Fu.MinkoYaochuFu, Fu.MinkoYaochuFu]), Expected: 30) // 20 + 4 + 4 = 28 → 30
        };
    ...
    {
        // Arrange
        List<Fu> fus = [Fu.FuteiFu, Fu.TsumoFu, Fu.WaitKanchanFu];
        ...
        Assert.Contains(Fu.FuteiFu, fuList);
        Assert.Contains(Fu.TsumoFu, fuList);
        Assert.Contains(Fu.WaitKanchanFu, fuList);
    }
    ...
    {
        // Arrange
        Span<Fu> fuSpan = [Fu.FuteiFu, Fu.TsumoFu, Fu.WaitKanchanFu];
    ...
    {
        // Arrange & Act
        FuList fuList = [Fu.FuteiFu, Fu.TsumoFu];
    ...
    {
        // Arrange
        var fuList1 = new FuList([Fu.FuteiFu, Fu.TsumoFu]);
        var fuList2 = new FuList([Fu.FuteiFu, Fu.TsumoFu]);
    ...
    public void Equals_内容が異なる場合_等価でないと判定されること()
    {
        // Arrange
        var fuList1 = new FuList([Fu.FuteiFu, Fu.TsumoFu]);
        var fuList2 = new FuList([Fu.FuteiFu, Fu.WaitKanchanFu]);
    ...
    public void Equals_順序が異なる場合_等価でないと判定されること()
    {
        // Arrange
        var fuList1 = new FuList([Fu.FuteiFu, Fu.TsumoFu]);
        var fuList2 = new FuList([Fu.TsumoFu, Fu.FuteiFu]);
